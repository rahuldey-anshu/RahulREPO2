...
public class MovieList extends JFrame {
	...
	public MovieList() {
		...
		movie1.setIcon(new ImageIcon(movie1path));         
		...
		movie2.setIcon(new ImageIcon(movie2path));
		...
		movie4.setIcon(new ImageIcon(movie4path));
		...
		lblMovies.setFont(new Font("Maiandra GD", Font.BOLD, 25));
