...
public class SupplierEntryPage extends JFrame {
	...
	public SupplierEntryPage() {
		...
		JLabel lblThisIsThe = new JLabel("This is the supplier section");
		...
		JLabel lblAddupdatesearchOr = new JLabel("Add,update,search or remove any supplier's details here. ");
		...
		JMenu mnSupllier = new JMenu("Supplier");
		menuBar.add(mnSupllier);
