...
public class Login {
	...
	private void initialize() {
		...
		btnClickToLogin.setIcon(new ImageIcon("assets//images//admin logo.png"));
		
		btnClickToLogin.addActionListener(new ActionListener() {
		...
		btnClickToLogin.setForeground(new Color(51, 0, 153));
		btnClickToLogin.setFont(new Font("Lucida Fax", Font.BOLD, 16));
		btnClickToLogin.setBackground(Color.WHITE);
		btnClickToLogin.setBounds(10, 416, 423, 175);
		panel_1.add(btnClickToLogin);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("assets//images//LOGO2.png"));
		lblNewLabel.setBounds(-13, 82, 471, 225);
